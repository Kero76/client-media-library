<?php
     ...
     * So, when the methods getAllXXX() are execute, it get all media from the file, and return an array composed by x
     * object. Then, if you execute these test on your own computing, you must insert all data on your Media Library to
     * valid test.
     *
    ...
    class RestClientTest extends TestCase {
        ...
        public function testGetMovieAndGet204Error() {
            ...
            $codeErrorExcepted = HttpCodeStatus::NO_CONTENT()
                                               ->getValue();
